        ...
        {activeSection === 'contact' && (
          <section aria-label="Contact information" id="contact" className='p-3'>
            ...
            <div className="contact-info">
              <a
                href="mailto:mmaginelius@gmail.com"
                className="contact-link"
                aria-label="Send email to maginelius@gmail.com"
              >
              ...
              <a
                href="https://github.com/search?q=comptronics&type=repositories"
                target="_blank"
              ...
              <a
                href="https://peopleperhour.com/Ellytheo"
                target="_blank"
                rel="noopener noreferrer"
                className="contact-link"
                aria-label="Visit my people/hour profile"
              >
                <span aria-hidden="true">
                  
                </span>
                peopleperhour.com/Elius Magin
              </a>
            </div>
          </section>
        )}
